            ...
            <div class="card chat-app">
                <div class="chat">
                    <div class="chat-header clearfix">
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="small_business_show_customer.php?customer_id=<?php echo $_GET['customer_id'];?>" data-toggle="modal" data-target="#view_info">
                                    <img src="https://bootdey.com/img/Content/avatar/avatar2.png" alt="avatar">
                                </a>
                                <div class="chat-about">
                                    <h3 class="m-b-0"><?php echo $customer_row['first_name'] . ' ' . $customer_row['last_name'];?></h3>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function(){
	...
	$("#submitmsg").click(function(){
		...
		// alert (message);
        $.post("small_business_chat_post_message.php", {content: message, small_business_id: <?php echo $small_business_id;?>, customer_id: <?php echo $customer_id;?>});             
...
function loadLog(){    
    ...
    $.ajax({
        url: "small_business_chat_messages_data.php?customer_id=" + customer_id,
        cache: false,
