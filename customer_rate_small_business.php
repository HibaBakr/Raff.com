...
<div class="cssignup-wrap">
	<div class="signup-html">
		<div class="signup-form">
			<h3>تقييم الأسرة</h3><br>
			<div id='signup' class="sign-up-htm" dir="rtl">
				<form id="rating_form" name="rating_form" action="customer_rate_small_business_check.php?small_business=<?php echo $_GET[id];?>" method="post" class=" sign-up-html" onsubmit="return check_rating();">
					...
					<div class="group">
					<br/>
						<input id="reg" name="submit" type="submit" class="button" value="تقييم"/>
					</div>
				</form>
			</div>
		</div>
